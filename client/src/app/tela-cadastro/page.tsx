...
import { cow,cachorro,horse,pig,sheep,calendar,alarm,cat } from "@/assets";
    ...
    return(
        <div className="flex flex-col items-start  min-h-screen bg-white">
            ...
            <div className=" flex flex-col gap-[10px] ml-[135px]  mt-[35px] mb-[60px] w-[calc(100%-135px-150px)] ">
                ...
                <div className="flex flex-row gap-4 mt-[10px] ">   {/* nome do paciente e tutor aqui */}
                ...
                <div className="flex-col mt-[8px]">    {/* imagens do animais com hover  */}
                            ...
                            >
                                <Image
                                    ...
                                    className={`object-cover ${
                                        img.id === "cachorro" ? "h-[100px] w-[90px]" : "h-[110px] w-[110px]"
                                    }`}
                                />
                            </div>
                        ))}
                ...
                <div className="flex flex-row gap-4 mt-[10px] ">   {/*barras de idade e tipo de consulta */}
                    <div className="flex flex-col w-full">
                    ...
                    <div className="flex flex-col w-full">
                        ...
                        <select className="w-full   border-2 border-gray-500 rounded-[8px]  h-[40px] flex items-center
                ...
                <div className="flex gap-4 mb-6 mt-[8px]"> {/* terceira linha com médio, horário e data */}
                    {/* Médico Responsável */}
                    <div className="w-[45%]">
                        <label className="block text-gray-1000 font-medium mb-2 font-bold">Médico Responsável</label>
                        <input
                            type="text"
                            placeholder="Digite aqui..."
