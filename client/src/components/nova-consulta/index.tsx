    ...
    <div className="relative w-[800px] mx-auto p-[45px] bg-white rounded-[20px] border border-gray-200 shadow-sm">
      ...
      <div className="items-center flex justify-center ">
        <img
          src={LogotipoSVG.src}
          alt="logo do citi"
          className="w-[150px] h-[100px] -mr-5"
        />
        <img
          src={pataSVG.src}
          alt="logo da pata com coração"
          className="w-[75px] h-[50px] mt-4"
        />
      </div>

      <p className="text-gray-700 mb-6 font-medium text-[16px] text-center">
        <strong>O pet já está cadastrado no sistema!</strong> Preencha os dados
        da <strong>consulta</strong>
      </p>
      ...
      <div className="flex gap-4 mb-6">
        ...
        <div className="flex-1">
          <label className="block text-gray-1000 font-medium mb-2">
            Tipo de consulta
          </label>
